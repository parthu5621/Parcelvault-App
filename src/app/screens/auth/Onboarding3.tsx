...
export function Onboarding3({ onComplete }: Onboarding3Props) {
  return (
    <div className="size-full flex flex-col bg-zinc-950">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="w-64 h-64 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-full flex items-center justify-center mb-8">
          <Bell className="w-32 h-32 text-blue-400" strokeWidth={1.5} />
        </div>

        <h2 className="text-3xl font-bold text-white mb-4 text-center">Real-Time Notifications</h2>
        <p className="text-zinc-400 text-center mb-8 px-4">
          Get instant alerts when your package arrives and track its status in real-time
        </p>
